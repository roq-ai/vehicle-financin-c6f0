  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Vehicle Financing Application - Your gateway to instant vehicle loans, seamless processing, swift approvals, flexible EMI options, and immediate disbursal with complete on-road price funding."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Vehicle Financing Application - Your gateway to instant vehicle loans, seamless processing, swift approvals, flexible EMI options, and immediate disbursal with complete on-road price funding.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Loan Officer" type="loan-officer" abilities={appConfig.ownerAbilities} />
