...
type ColumnType = ColumnDef<LenderInterface, unknown>;

interface LenderListPageProps {
...
export function LenderListPage(props: LenderListPageProps) {
  const {
    filters = {},
    titleProps = {},
  ...
  const { data, error, isLoading, mutate } = useSWR<PaginatedInterface<LenderInterface>>(
    () => `/lenders?params=${JSON.stringify(params)}`,
    fetcher,
  );
      ...
      ? {
          ...
          cell: ({ row: { original: record } }: any) => (
            <Flex justifyContent="flex-end">
              <NextLink href={`/lenders/view/${record.id}`} passHref legacyBehavior>
                <Button
