...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'loan_application_submitted.create': {
    roles: ['loan-officer', 'customer-service-representative'],
    key: 'loan_application_id',
    tenantPath: [],
    userPath: [],
  },
  'loan_status_updated.update': {
    roles: ['loan-officer', 'customer-service-representative'],
    key: 'loan_application_id',
    tenantPath: [],
    userPath: [],
  },
  'customer_feedback_received.create': {
    roles: ['loan-officer', 'customer-service-representative'],
    key: 'feedback_id',
    tenantPath: [],
    userPath: [],
...
const ownerRoles: string[] = ['loan-officer'];
const customerRoles: string[] = ['customer'];
const tenantRoles: string[] = ['loan-officer', 'customer-service-representative'];
