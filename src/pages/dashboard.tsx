...
import { getLoanOfficers } from 'apiSdk/loan-officers';
...
import { LoanOfficerListPage as ShowCaseList } from 'pages/loan-officers';
...
function DashboardPage() {
  ...
  const loanOfficerStat = useSWR<PaginatedInterface<LoanOfficerInterface>>(
    () => `/loan-officers`,
    () => getLoanOfficers({ limit: 1, offset: 0 }),
  );
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    ...
    {
      title: 'Loan Officers',
      result: loanOfficerStat?.data?.totalCount,
            ...
            <Box>
              <Flex mb={4} justifyContent={'space-between'}>
                <Text as="b" fontSize="xl">
                  Latest Loan Officers
                </Text>
                <NextLink href={`loan-officers`} passHref legacyBehavior>
                  <Button
